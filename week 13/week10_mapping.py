...
# %%
file = os.path.join('..\data', '10ffa493-aa79-412a-88e1-d787c8e3ae94202042-1-1s47isu.kjf5.shp')
azstate = gpd.read_file(file)
...
azstate.plot(ax=ax)
ctx.add_basemap(ax)
ctx.add_attribution(ax,'Testing this map')
plt.show()
...
gages_AZ.shape
gages_NM = gages[gages['STATE']=='NM']
gages_UT = gages[gages['STATE']=='UT']
# %%
