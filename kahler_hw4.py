...
#filepath='Documents/Has_Tools_git/homework-akahler03/data/filename'
print(os.getcwd())
print(filepath)
...
mybins=15
plt.hist(septwk1_oneyr[:,3], bins = mybins)
...
flow_quants1 = np.quantile(septwk1_oneyr[:,3], q=[0,0.1, 0.5, 0.9])
